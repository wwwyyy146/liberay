...
CREATE TABLE `borrow_book`  (
  `borrow_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `book_id` int(0) NULL DEFAULT NULL COMMENT '图书id',
  `reader_id` int(0) NULL DEFAULT NULL COMMENT '读者id',
...
-- ----------------------------
INSERT INTO `borrow_book` VALUES (128, 2, 6, '2024-03-24 16:08:08', '2024-07-31 00:00:00', '1', '1', NULL, NULL, NULL);
INSERT INTO `borrow_book` VALUES (129, 6, 6, '2024-03-24 16:08:08', '2024-07-31 00:00:00', '1', '1', NULL, NULL, NULL);
INSERT INTO `borrow_book` VALUES (130, 6, 6, '2024-03-24 16:16:17', '2024-10-25 00:00:00', '1', '1', NULL, NULL, NULL);
INSERT INTO `borrow_book` VALUES (131, 5, 6, '2024-03-24 16:35:43', '2024-03-31 00:00:00', '0', '0', NULL, NULL, NULL);
INSERT INTO `borrow_book` VALUES (132, 6, 6, '2024-03-24 16:35:43', '2024-03-31 00:00:00', '0', '0', NULL, NULL, NULL);
...
CREATE TABLE `sys_books`  (
  ...
  `book_store` int(0) NULL DEFAULT 0 COMMENT '库存',
...
-- ----------------------------
INSERT INTO `sys_books` VALUES (2, 3, '数字上的中国', '974651231', 'C1-2', '黄奇帆，陈春花', '中信出版社', 68.00, 0);
INSERT INTO `sys_books` VALUES (5, 3, '赢在IPO', '7846113213', 'C2-1', '谢晖，杜超，林可成', '人民邮电出版社', 79.80, 0);
INSERT INTO `sys_books` VALUES (6, 5, '编程真好玩', '71313456466', 'E2-2', '(日)冈田哲郎', '中国青年出版社', 129.00, 0);
INSERT INTO `sys_books` VALUES (7, 5, 'Python3网络爬虫开发', '7841354646', 'E2-3', '崔庆才', '人民邮电出版社', 139.80, 5);
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, 0, '系统管理', 'sys:menu:setting', 'system', '/system', '', '0', 'iconfont icon-r-setting', '顶级菜单', 1, '2021-12-02 19:19:28', NULL);
INSERT INTO `sys_menu` VALUES (2, 1, '用户管理', 'sys:useList:index', 'sysUserList', '/sysUserList', '/system/sysUserList', '1', 'iconfont icon-r-user1', '系统管理', 2, '2021-12-02 19:25:31', '2022-02-11 11:45:15');
INSERT INTO `sys_menu` VALUES (3, 1, '角色管理', 'sys:sysRoleList:index', 'sysRoleList', '/sysRoleList', '/system/sysRoleList', '1', 'iconfont icon-r-user2', '系统管理', 3, '2021-12-02 19:27:25', '2022-02-11 14:09:18');
INSERT INTO `sys_menu` VALUES (4, 1, '菜单管理', 'sys:menu:index', 'sysMenuList', '/sysMenuList', '/system/sysMenuList', '1', 'iconfont icon-r-edit', '系统管理', 3, '2022-01-02 13:20:44', NULL);
...
INSERT INTO `sys_menu` VALUES (14, 0, '读者管理', 'sys:reader:root', 'reader', '/reader', '', '0', 'iconfont icon-r-team', '顶级菜单', 2, '2022-01-02 13:24:42', '2022-02-11 14:21:56');
INSERT INTO `sys_menu` VALUES (15, 14, '读者列表', 'sys:reader:list', 'readerList', '/readerList', '/reader/readerList', '1', 'iconfont icon-r-team', '读者管理', 1, '2022-01-02 13:25:29', '2022-02-11 14:22:29');
...
INSERT INTO `sys_menu` VALUES (19, 0, '图书管理', 'sys:book:index', 'book', '/book', '', '0', 'iconfont icon-r-paper', '顶级菜单', 3, '2022-01-02 13:27:11', '2022-02-11 14:11:59');
INSERT INTO `sys_menu` VALUES (20, 19, '图书分类', 'sys:bookCategory:index', 'bookCategory', '/bookCategory', '/book/bookCategory', '1', 'iconfont icon-r-paper', '图书管理', 1, '2022-01-02 13:28:10', '2022-02-11 14:13:53');
INSERT INTO `sys_menu` VALUES (21, 19, '图书列表', 'sys:bookList:list', 'bookList', '/bookList', '/book/bookList', '1', 'iconfont icon-r-list', '图书管理', 2, '2022-01-02 13:28:59', '2022-02-11 14:22:48');
...
INSERT INTO `sys_menu` VALUES (28, 0, '借阅管理', 'sys:borrow:index', 'borrow', '/borrow', '', '0', 'iconfont icon-r-refresh', '顶级菜单', 5, '2022-01-02 13:32:02', '2022-02-11 14:23:29');
INSERT INTO `sys_menu` VALUES (29, 28, '借书管理', 'sys:bookBorrow:index', 'bookBorrow', '/bookBorrow', '/borrow/bookBorrow', '1', 'iconfont icon-r-left', '借阅管理', 1, '2022-01-02 13:33:07', '2022-02-11 14:23:13');
INSERT INTO `sys_menu` VALUES (30, 28, '还书管理', 'sys:bookReturn:index', 'bookReturn', '/bookReturn', '/borrow/bookReturn', '1', 'iconfont icon-r-right', '借阅管理', 2, '2022-01-02 13:33:58', '2022-02-11 14:23:43');
INSERT INTO `sys_menu` VALUES (31, 28, '借阅查看', 'sys:borrowLook:index', 'borrowLook', '/borrowLook', '/borrow/borrowLook', '1', 'iconfont icon-r-find', '借阅管理', 3, '2022-01-02 13:34:48', NULL);
INSERT INTO `sys_menu` VALUES (32, 0, '公告管理', 'sys:notice:index', 'notice', '/notice', '', '0', 'iconfont icon-r-edit', '顶级菜单', 6, '2022-01-02 13:35:27', '2022-02-11 14:12:36');
INSERT INTO `sys_menu` VALUES (33, 32, '公告列表', 'sys:noticeList:index', 'noticeList', '/noticeList', '/notice/noticeList', '1', 'iconfont icon-r-edit', '公告管理', 1, '2022-01-02 13:36:14', '2022-02-26 17:05:46');
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES (9, '兔兔图书馆正式开馆', '4月1日兔兔图书馆正式开馆了，欢迎读者们加入', '2024-03-24 15:38:12');
...
-- ----------------------------
INSERT INTO `sys_reader` VALUES (6, '刘美', '2024001', '789456463313134343', '0', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '软件1班');
INSERT INTO `sys_reader` VALUES (7, '可莉', '2024002', '443228945613212313', '0', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '机械1班');
INSERT INTO `sys_reader` VALUES (8, '阿拉亚', '2024003', '441678646113213331', '0', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '软件1班');
INSERT INTO `sys_reader` VALUES (10, '凯亚', '2024004', '489445112123343424', '0', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '软件3班');
INSERT INTO `sys_reader` VALUES (12, '七七', '2024005', '444458884666323451', '1', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '财会2班');
INSERT INTO `sys_reader` VALUES (13, '温迪', '2024006', '343434333333424445', '1', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '软工6班');
INSERT INTO `sys_reader` VALUES (14, '叶子', '2024007', '432333227736432441', '1', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '数据2班');
INSERT INTO `sys_reader` VALUES (15, '王七八', '2024008', '443332222224323434', '0', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '软工4班');
INSERT INTO `sys_reader` VALUES (16, '郑八八', '2024009', '444333322453423243', '1', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '数据1班');
INSERT INTO `sys_reader` VALUES (17, '白宇', '2024010', '202133334444432224', '1', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '软件3班');
INSERT INTO `sys_reader` VALUES (18, '王晓红', '2024011', '441571648745434354', '0', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '软工1班');
INSERT INTO `sys_reader` VALUES (21, '陈小明', '2024012', '124879548745647894', '0', '13477777777', 'e10adc3949ba59abbe56e057f20f883e', '1', '1', '1', '软工10班');
...
CREATE TABLE `sys_reader_role`  (
  `reader_role_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `reader_id` int(0) NULL DEFAULT NULL COMMENT '读者id',
...
INSERT INTO `sys_reader_role` VALUES (46, 21, 5);
INSERT INTO `sys_reader_role` VALUES (47, 6, 5);
...
CREATE TABLE `sys_user`  (
  ...
  `is_account_non_expired` tinyint(0) NULL DEFAULT NULL COMMENT '帐户是否过期(1 未过期，0已过期)',
  `is_account_non_locked` tinyint(0) NULL DEFAULT NULL COMMENT '帐户是否被锁定(1 未锁定，0已锁定)',
  `is_credentials_non_expired` tinyint(0) NULL DEFAULT NULL COMMENT '密码是否过期(1 未过期，0已过期)',
  `is_enabled` tinyint(0) NULL DEFAULT NULL COMMENT '帐户是否可用(1 可用，0 删除用户)',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (3, 'superadmin', 'e10adc3949ba59abbe56e057f20f883e', '13477777777', '11232324344@qq.com', '0', '1', 1, 1, 1, 1, '超级管理员张三', '2021-11-30 15:05:04', '2024-03-24 16:00:58');
INSERT INTO `sys_user` VALUES (9, 'admin', 'e10adc3949ba59abbe56e057f20f883e', '19977777777', '19977777777@qq.com', '1', '0', 1, 1, 1, 1, '管理员李四', '2022-02-14 21:31:52', '2024-03-24 15:56:11');
